---
title: IntelliJ IDEA 2021.3.3激活破解教程
date: 2022-04-24 10:11:00
categories: 
  - [Intellij]  
toc: true
---
...
测试我的版本IntelliJ IDEA 2021.3.3永久激活，IntelliJ IDEA 2022.1只能激活一年，其他没试过。

<!--more-->

IntelliJ IDEA版本：IntelliJ IDEA 2021.3.3



###### 下载激活脚本

链接：https://pan.baidu.com/s/1E47hsL1rtHpCke3EB-Em6Q?pwd=1gua 
提取码：1gua

将下载文件的ja-netfilter-all目录移动到其他位置，确保路径无中文。

![image-20220424104857433](http://image.blog.cdzq.ltd/image-20220424104857433.png)

###### 执行install-current-user.vbs激活脚本

![image-20220424104946014](http://image.blog.cdzq.ltd/image-20220424104946014.png)

点确定安装

![安装IDEA激活破解补丁提示框](http://image.blog.cdzq.ltd/164412225024259)

补丁安装成功

![IDEA 激活破解补丁安装成功](http://image.blog.cdzq.ltd/164412243670186)

###### 重启 IDEA

###### 打开 IDEA, 填入指定激活码完成激活

![image-20220424105354496](http://image.blog.cdzq.ltd/image-20220424105354496.png)
...
引用地址：https://www.exception.site/essay/how-to-free-use-intellij-idea-2019-3